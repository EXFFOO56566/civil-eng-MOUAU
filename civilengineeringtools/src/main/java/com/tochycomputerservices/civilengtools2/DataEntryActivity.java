...
import com.tochycomputerservices.civilengtools2.data.ASADBContract;
...
public class DataEntryActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
                ...
                if (recievedUri != null) {
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            startActivity(new Intent(getApplicationContext(), AsaActivity.class));
                        }
                    });
    ...
    public void onBackPressed()
    {
        ...
        builder.setPositiveButton("OKAY", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Intent intent = new Intent(getApplicationContext(), AsaActivity.class);
